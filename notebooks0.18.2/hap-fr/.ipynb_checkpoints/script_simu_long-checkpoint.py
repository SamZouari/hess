...
with open(pathres/f'GC_fluxes_simu_{year}.txt', 'w') as filehandle:
    for listitem in GCflux_distribution:
        filehandle.write('%s\n' % listitem)

with open(pathres/f'DE_fluxes_simu_{year}.txt', 'w') as filehandle:
    for listitem in DEflux_distribution:
        filehandle.write('%s\n' % listitem)
